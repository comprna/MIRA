...
#Note cutoff values:
#cat sclc_all_genes_mutations_7mer.tab | wc -l : 4737594
#cat sclc_all_genes_mutations_7mer.tab | awk '$12>6' | wc -l : 2403097
#cat sclc_all_genes_mutations_7mer.tab | awk '$12>7' | wc -l : 1188671
